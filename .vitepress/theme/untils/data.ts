import type { NavData } from '../utils/types'
...
export const NAV_DATA: NavData[] = [

  {
    ...
    items: [
      {
        icon: 'https://pic.imgdb.cn/item/67375d49d29ded1a8cd08d80.png',
        title: '吃转三职',
        // badge: {
        //   text: 'api',
        //   type: 'info',
      ...
      {
        icon: 'https://mywebsite.ljjk.love/assets/img/img-4.svg',
        title: '网站小坊',
        desc: '一个搜集了各种好看网页的仓库',
        link: 'https://mywebsite.ljjk.love/'
      },
      {
        icon: 'https://img.icons8.com/?size=512&id=90519&format=png',
        title: 'spring boot多模块整合框架',
        badge: {
          text: 'template',
          type: 'tip',
        },
        desc: 'spring boot框架',
        link: 'https://github.com/JiaShuaikai/springboot-multi-module'
      },
      {
        icon: 'https://www.ljjk.love/xiaoxiao/assets/logo/logo.png',
        title: '小小请求',
        desc: '跨平台 轻量级 接口调试利器',
        link: 'https://www.ljjk.love/xiaoxiao/'
      },
      {
